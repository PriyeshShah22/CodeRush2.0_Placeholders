...
class ComplaintStatus(str, enum.Enum):
    submitted="submitted"; processing="processing"; awaiting_review="awaiting_review"; assigned="assigned"; acknowledged="acknowledged"; in_progress="in_progress"; escalated="escalated"; resolved="resolved"; reopened="reopened"; rejected="rejected"
